...
export const MARKETING_FAQS: MarketingFaq[] = [
  ...
  },
  {
    ...
    answer: [
      "Yes. Lakshya offers Non-Cosigner Loan (without guarantee) programs through selected lending partners.",
      ...
      "Our experts will evaluate your profile and help you identify the best Non-Cosigner Loan (without guarantee) options available.",
    ].join("\n\n"),
  },
  {
    category: "Loan Types",
    question:
      "How do collateral, non-collateral, and Non-Cosigner Loan (without guarantee) education loans work?",
    answer: [
      ...
      "## Non-Cosigner Loan (without guarantee)",
