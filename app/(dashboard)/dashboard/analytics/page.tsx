...
const AnalyticsKpiCards = dynamic(
  ...
  { loading: () => <Skeleton className="h-24 rounded-[20px] bg-[#0B8FD8]/8" /> }
);
const VisualFunnelChart = dynamic(
  () => import("@/components/charts/analytics-charts").then((m) => m.VisualFunnelChart),
  { loading: () => <Skeleton className="h-96 rounded-[20px] bg-[#0B8FD8]/8" /> }
);
...
const AnalyticsHeatMap = dynamic(
  ...
  { loading: () => <Skeleton className="h-64 rounded-[20px] bg-[#0B8FD8]/8" /> }
);
