    ...
    <>
      <header className="sticky top-0 z-40 flex min-h-12 flex-wrap items-center gap-2 sm:min-h-14 sm:gap-3">
        <button
          ...
          className="inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-full glass-surface transition-all hover:bg-[#0B8FD8]/8 lg:hidden dark:bg-white/5"
        >
          <Menu className="h-5 w-5 text-[#0B8FD8]" />
        </button>
        ...
        >
          <Search className="h-4 w-4 shrink-0 text-[#0B8FD8]/60 transition-colors group-hover:text-[#0B8FD8]" />
          <span className="min-w-0 truncate text-sm text-muted-foreground">
            <span className="hidden sm:inline">Search students, partners...</span>
            <span className="sm:hidden">Search...</span>
          </span>
          <kbd className="pointer-events-none ml-auto hidden h-6 shrink-0 select-none items-center rounded-full border border-[#0B8FD8]/15 bg-[#0B8FD8]/5 px-2 font-mono text-[10px] font-medium text-[#0B8FD8] sm:flex">
            {searchShortcutLabel}
          </kbd>
        </button>
        ...
        <div className="ml-auto flex shrink-0 items-center gap-1 sm:gap-1.5">
          <DropdownMenu open={notificationsOpen} onOpenChange={handleNotificationsOpenChange}>
            <DropdownMenuTrigger className="relative inline-flex h-9 w-9 items-center justify-center rounded-full glass-surface transition-all hover:bg-[#0B8FD8]/8 sm:h-10 sm:w-10 dark:bg-white/5">
          ...
          <DropdownMenu>
            <DropdownMenuTrigger className="relative hidden h-9 w-9 items-center justify-center rounded-full glass-surface transition-all hover:bg-[#0B8FD8]/8 sm:inline-flex sm:h-10 sm:w-10 dark:bg-white/5">
          ...
          <DropdownMenu>
            <DropdownMenuTrigger className="inline-flex">
              <Avatar className="h-9 w-9 ring-2 ring-[#0B8FD8]/20 transition-all hover:ring-[#0B8FD8]/40 sm:h-10 sm:w-10">
                <AvatarImage src={user?.avatar ?? undefined} />
                <AvatarFallback className="bg-gradient-to-br from-[#0B8FD8] to-[#0369A1] text-xs text-white">
