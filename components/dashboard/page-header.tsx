    ...
    <div className="page-header-band relative overflow-hidden p-5 sm:p-6">
      ...
      <div className="relative z-10 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
        <div className="min-w-0">
          {badge && (
            <span className="mb-2 inline-flex items-center rounded-full bg-primary/10 px-3 py-1 text-xs font-semibold text-primary dark:bg-primary/16 dark:text-[#7DD3FC]">
              {badge}
            </span>
          )}
