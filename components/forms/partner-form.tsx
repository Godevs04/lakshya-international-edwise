...
export function PartnerForm({ initialData, partnerId, mode, focusSection }: PartnerFormProps) {
  ...
  const [actionStatus, setActionStatus] = useState(
    (initialData?.actionStatus as string) ?? "active"
  );
      ...
      {isSectionEdit && !isFormSectionVisible("company") ? (
        <>
          ...
          <input
            type="hidden"
            name="locationCity"
            value={String(initialData?.locationCity ?? "")}
          />
          <input
            type="hidden"
            name="locationState"
            value={String(initialData?.locationState ?? "")}
          />
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <div className="space-y-2">
              ...
              <Input
                id="locationCity"
                name="locationCity"
                defaultValue={initialData?.locationCity as string}
              />
            </div>
            <div className="space-y-2">
              ...
              <Input
                id="locationState"
                name="locationState"
                defaultValue={initialData?.locationState as string}
              />
            </div>
            <div className="space-y-2 sm:col-span-2">
              <LinkUrlField
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <div className="space-y-2">
              ...
              <Input
                id="accountName"
                name="accountName"
                defaultValue={initialData?.accountName as string}
              />
            </div>
            <div className="space-y-2">
