...
describe("email-templates", () => {
  ...
  it("resolves relative logo paths to absolute URLs for email clients", () => {
    ...
    expect(html).toContain('src="https://lakshyainternationaledwise.com/Lakshya-App-logo-256.png"');
  });

  it("falls back to public/Lakshya-App-logo-256.png when company logo is empty", () => {
    const html = renderEmailLayout({
      company: {
        name: "Lakshya International Edwise",
        logo: "",
  ...
  it("uses APP_EMAIL_BANNER_URL as the compact header logo", () => {
    ...
    expect(html).not.toContain(
      'src="https://lakshyainternationaledwise.com/Lakshya-App-logo-256.png"'
    );
  ...
  it("falls back to company logo when APP_EMAIL_BANNER_URL is unset", () => {
    ...
    ).toBe("https://lakshyainternationaledwise.com/Lakshya-App-logo-256.png");
...
describe("resolveEmailAssetUrl", () => {
  ...
  it("prefixes relative paths with the app URL", () => {
    process.env.AUTH_URL = "https://lakshyainternationaledwise.com";
    expect(resolveEmailAssetUrl("/Lakshya-App-logo-256.png")).toBe(
      "https://lakshyainternationaledwise.com/Lakshya-App-logo-256.png"
    );
  });
